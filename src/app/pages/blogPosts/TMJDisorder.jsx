...
const TMJDisorderSymptoms = () => {
  ...
  />
        ...
        <div className="pt-6">
          ...
          <h2 className="text-2xl cm800:text-[2rem] font-semibold pb-2 pt-4">
          ...
          <ol className="list-decimal cm800:ml-10 pb-4">
            <li className="cm800:text-[1.2em] ml-5">
          ...
          <p className="cm800:text-[1.2em] font-semibold">Marta Suchanska</p>
...
export default TMJDisorderSymptoms;
