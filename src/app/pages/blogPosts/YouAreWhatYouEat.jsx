  ...
  return (
    <>
      ...
      <div className="w-[95%] cm800:w-[75%] m-auto text-black">
        <img className="h-[50vh] w-full object-cover rounded-3xl" src="/resources/blog eat.jpg" />
        <Link href={"/blog"}>
        ...
        <div className="pt-4">
          ...
          <h3 className="text-2xl cm800:text-4xl font-semibold pb-2 py-2">
          ...
          <h3 className="text-2xl cm800:text-4xl font-semibold pb-2">{`With all this information, it is quite easy to feel lost.`}</h3>
          <p className="cm800:text-xl">
          ...
          <h3 className="text-2xl cm800:text-4xl font-semibold pb-2">{`So what should we do?`}</h3>
          <h3 className="text-2xl cm800:text-4xl font-semibold pb-2">{`Each of us should choose a diet that best suits our needs.`}</h3>
          <p className="cm800:text-xl">
          ...
          <h3 className="text-2xl cm800:text-4xl font-semibold pb-2">{`There are a few golden rules that, if followed, yield huge results:`}</h3>
          <ul className="list-disc ml-8 pb-4">
            <li className="cm800:text-xl">
          ...
          <p className="cm800:text-xl">{`And all this is nicely represented by the saying:`}</p>
          <h3 className="text-2xl cm800:text-4xl font-semibold pb-2">{`Eat breakfast like a king, lunch like a prince, and dinner like a pauper.`}</h3>
          <ul className="list-disc ml-8 pb-4">
            <li className="cm800:text-xl">
            ...
            <li className="cm800:text-xl">{`Cutting down on processed products`}</li>
            <li className="cm800:text-xl">
          ...
          <p className="cm800:text-xl">{`See you soon!`}</p>
          <p className="cm800:text-xl">{`Marta`}</p>
          <BespokeButton />
        </div>
      </div>
      <ContactInfo />
