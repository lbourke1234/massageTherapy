  ...
  return (
    <div className="text-black bg-[#EFEBE0]">
      <div className="cmMobile:w-[90%] cm1500:w-3/5 m-auto py-8">
        ...
        <h3 className="font-medium text-2xl mb-2">Cancellation and Rescheduling</h3>
        <p>{`Cancellations and rescheduling: 48hrs cancellation policy with full refund on all treatments.`}</p>
        <p>
